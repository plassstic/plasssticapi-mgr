...
func (_u *UserUpdate) SetEditable(v schema.Editable) *UserUpdate {
	_u.mutation.SetEditable(v)
	return _u
}

// SetNillableEditable sets the "editable" field if the given value is not nil.
func (_u *UserUpdate) SetNillableEditable(v *schema.Editable) *UserUpdate {
	if v != nil {
		_u.SetEditable(*v)
	}
	return _u
...
// SetEditable sets the "editable" field.
func (_u *UserUpdateOne) SetEditable(v schema.Editable) *UserUpdateOne {
	_u.mutation.SetEditable(v)
	return _u
}

// SetNillableEditable sets the "editable" field if the given value is not nil.
func (_u *UserUpdateOne) SetNillableEditable(v *schema.Editable) *UserUpdateOne {
	if v != nil {
		_u.SetEditable(*v)
	}
	return _u
